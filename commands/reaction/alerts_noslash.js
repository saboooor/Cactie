...
module.exports = {
	...
	async execute(message, user, client, reaction) {
		if (message.guild.id !== '711661870926397601' && message.guild.id !== '865519986806095902' && message.guild.id !== '837116518730694678' && client.user.id !== '765287593762881616') return;

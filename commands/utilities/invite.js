...
module.exports = {
	...
	async execute(message, args, client) {
		...
		const Embed = new Discord.MessageEmbed()
			...
			.addField('**Add the bot:**', '[Invite Pup to your server using this link!](https://discord.com/api/oauth2/authorize?client_id=765287593762881616&permissions=2184703062&scope=bot%20applications.commands)')

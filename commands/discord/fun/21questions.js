...
module.exports = {
	...
	async execute(message, args, client, lang) {
		...
		collector.on('end', () => {
			if (collector.collected.size == 0) questionmsg.edit({ content: 'A game of 21 Questions should not last longer than an hour are you high', components: [], embeds: [] }).catch(err => client.logger.warn(err));
		});
	},
};
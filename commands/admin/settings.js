					...
					channel.permissionOverwrites.edit(role, { SEND_MESSAGES: false }).catch(e => {
						if (`\`${`${e}`.split('at')[0]}\``.includes('Missing Permissions')) {
							const ErrorEmbed = new Discord.MessageEmbed()
								...
								.setDescription('[Try fixing this by clicking here](https://discord.com/api/oauth2/authorize?client_id=765287593762881616&permissions=2416307446&scope=applications.commands%20bot)');

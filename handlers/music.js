		...
		(Player) =>
			class extends Player {
				setNowplayingMessage(message) {
					if (this.nowPlayingMessage && this.nowPlayingMessage.embeds[0]) this.nowPlayingMessage.edit({ embeds: [compressEmbed(this.nowPlayingMessage.embeds[0])], components: [] }).catch(err => client.logger.error(err));
